...
void MainMenu::Initialize() {
    ...
    AddNewObject(new Engine::Label("Beat Game", "pirulen.ttf", 120, halfW, halfH / 5 + 50, 10, 255, 255, 255, 0.5, 0.5));
    ...
    AddNewObject(new Engine::Label("Start", "pirulen.ttf", 48, halfW - 600, halfH + 300, 255, 255, 255, 255, 0.5, 0.5));
    ...
    AddNewControlObject(btn);
    AddNewObject(new Engine::Label("Settings", "pirulen.ttf", 48, halfW + 600, halfH + 300, 255, 255, 255, 255, 0.5, 0.5));
